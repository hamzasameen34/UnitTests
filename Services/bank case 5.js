const getStub = () => {
        ...
        bankAccounts: [
          {
            ...
            bank: "Meezan",
            bankAccountNumber: "asdsdvd12342sdfwdfdwfvefwgefgefgefgefgwefe3432"
          }
        ],
        batches: [
          {
  ...
  let expected = false;
  let identifier = "bankAccountNumber is out of bounds. (min length:5, max length:24) > bank case 5 "
