//billingCycle having part of an accepted value

const getStub = () => {
    return {service:{ billingCycle: 'monthl',
  ...
  let expected = false;
  let identifier = 'Billing Cycle having part of an accepted value > billing cycle case 2'
