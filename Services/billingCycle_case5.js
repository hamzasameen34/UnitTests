//billingCycle with value that has an accepted value as its part

const getStub = () => {
    return {service:{ billingCycle: 'monthly2',
  ...
  let expected = false;
  let identifier = 'Billing cycle with value that has an accepted value as its part > billing cycle case 5'
