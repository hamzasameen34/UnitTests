//payment priority of component Electricity Charges set to null
...
const getStub = () => {
  ...
  let expected = false;
  let identifier = 'payment priority of component Electricity Charges set to null > components case 7'
