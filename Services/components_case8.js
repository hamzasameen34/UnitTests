//payment priority of component Electricity Charges set to undefined
...
const getStub = () => {
  ...
  let expected = false;
  let identifier = 'payment priority of component Electricity Charges set to undefined > components case 8'
