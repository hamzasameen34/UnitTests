//G1 Street Light Applied with List dataType and ',No' as value
...
const getStub = () => {
  ...
  let expected = false;
  let identifier = "G1 Street Light Applied with List dataType and ',No' as value > connection inputs case 5"
