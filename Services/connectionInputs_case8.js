//KWH Meter connection input not given while KWH meteredInput is present
...
const getStub = () => {
  ...
  let expected = false;
  let identifier = "KWH Meter connection input not given while KWH meteredInput is present > connection inputs case 8"
