const getStub = () => {
        ...
        unmeteredInputs: [
          {
            ...
            serviceCode: "IZM10345",
            parameterID: null,
            name: "gffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffdsfre45",
            type: "Number",
            values: null
          }
        ],
  ...
  let expected = false;
  let identifier = "Unmetered inputs > name is out of bounds. (min length:1, max length:50) > unmetered inputs case 3"
