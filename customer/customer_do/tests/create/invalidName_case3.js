//Name field having invalid characters
const getStub = () => {
    return {
        users:
            [
                {
                    ...
                    roleID: 2, //Unrelated
                    name: 'Rehan@wqdhvqsbjdcewqgdhs cwhdgwevfwdcsn cwegf gewvsdg2ve$', //Required. MinLen: 3, MaxLen: 50
...
const identifier = "Name field having invalid input > invalid name case 3"
