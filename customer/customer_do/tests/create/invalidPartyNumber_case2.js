//Party Number set to negative
const getStub = () => {
    return {
        users:
            [
                {
                    partyNumber: -1, //Required. Min: 1, Max: Infinity
                    ...
                    buildingNo: 15, //Optional. Min: 1, Max: Infinity
...
const identifier = "Party number having invalid i.e. negative value > invalid party number case 2"
