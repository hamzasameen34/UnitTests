const getStub = () => {
    return {
        ...
        {
            users:
                'customer number,name,cnic,building number,bulding name,shop number,street,block,society,city,country,contact type,contact,additional information,title@#52,Freda,39706-6089523-5,1,Juliana,896,h4,U,Izmir,Lahore,1,Mobile,0300-0000000,nothing,Mr@#42,Freda,39700-6089523-5,1,Juliana,896,h4,U,Izmir,Lahore,1,Mobile,+923000000000,nothing,Mr@#',
...
const identifier = "Invalid contact input > Invalid Contact case 3"
